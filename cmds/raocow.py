            ...
            for channel_id in channel_ids:
                ...
                with sqlcon.cursor() as cursor:
                    for item in playlists['items']:
                        ...
                        cursor.execute('''
                                        INSERT INTO pepper.raocow_playlists rp (playlist_id, title, datestamp, length, duration, thumbnail, latest_video) VALUES (%s, %s, %s, %s, %s, %s, %s) ON CONFLICT (playlist_id) DO UPDATE
                                        SET datestamp = EXCLUDED.datestamp, length = EXCLUDED.length, duration = COALESCE(rp.duration, EXCLUDED.duration),
